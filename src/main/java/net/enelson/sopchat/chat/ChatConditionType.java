...
public enum ChatConditionType {
    ...
    ChatConditionType(List<String> identifiers) {
        this.identifiers = identifiers;
    }

    public static ChatConditionType fromString(String input) {
        if (input == null) {
            return null;
        }
        for (ChatConditionType type : values()) {
